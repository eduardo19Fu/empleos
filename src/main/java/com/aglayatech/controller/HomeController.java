...
import com.aglayatech.model.Perfil;
...
public class HomeController {
	...
	public String guardar(Usuario usuario, RedirectAttributes attributes) {
		...
		attributes.addFlashAttribute("mensaje", "El usuario ha sido registrado con éxito!");
	...
	public String buscar(@ModelAttribute("search") Vacante vacante, Model model) {
		System.out.println("Buscando por: " + vacante);
		                                        ...
		                                        // where descripcion like '%?%', solamente para parametros que sean texto plano
	...
	/**
	 * 
	 * Init Binder para Strings si los detecta vacios en el Data Binding los setea a NULL
	 * @param binder
	 *
	 */
